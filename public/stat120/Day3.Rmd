...
of another variable, we call the former the .b[explanatory variable] and
the latter the .b[response variable]
]
...
- If possible, randomized experiments should be .b[double-blinded:] neither the participants or the researchers evaluating participants should know which treatment the participants are actually getting
]
