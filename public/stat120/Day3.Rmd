...
.bq[Two variables are .bold[associated] if values of one variable tends to
...
.bq[Two variables are .bold[causally associated] if changing the value of
...
.bq[Based on this passage, should we conclude that obtaining a college
...
.center.font140.bold[What is the reason?]
...
# Randomized Experiments: other types

.bql.font80[

- .green-h[Blocking]: Individuals in the study are divided into subgroups (blocks) and then randomly assigned to different treatments within each block. 

- .green-h[Split Plots]: Individuals are randomly assigned to a main treatment and then randomly assigned to a sub-treatment. 

- .green-h[Latin Squares]: Individuals are randomly assigned to treatments in a way that minimizes the effect of order. 

- .green-h[Factorial Experiments]: Individuals are randomly assigned to different combinations of treatments.
