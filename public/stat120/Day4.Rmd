...
`r chunk_reveal("bar-plot", font_size_code="50%", title = "## Graphical summary: bar plot")`

```{r bar-plot, fig.width = 3, fig.height = 3.5, out.width = "100%", include=FALSE}
counts_df <- data.frame(x=c("Not Struck by State", "Struck by State"), y=c(1084, 433))
