---
title: "Day 7: Sampling Distribution and Bootstrap"
...
.blockquote-list[.bold[Statistical inference]  is the process of drawing conclusions about the entire population based on information in a sample.]
...
.pull-right[
<br>
.blockquote-list[The sample proportion can be used as a “point estimate” of $p$ i.e.,
$$\hat{p}= 0.60$$]
]
...
> A .bold[sampling distribution] is the distribution of sample statistics computed for different samples of the same size from the same population.
...
<br>
<center>
<img src="images/sampprop.png" width="60%" height="60%"><br>
<a>Distribution of 1000 sample proportions with p=0.65</a>
</center>
]
...
.pull-right[
![Sampling Distribution](images/stderror.png)
...
.yellow-h.font80[What are each dots?]

<center>
<img src="images/gettys.png" width="45%" height="45%"><br>
</center>
...
.blue[The variability of the population!]
...
.pull-left[
.blockquote[What does each dot represent?
...
.blockquote.font90[Samples of .bold[size] 5 are taken from a large population with .bold[population mean] 8, and the sampling distributions for the sample means are shown.  Dataset A (top) and Dataset B (bottom) were collected using different sampling methods.  Which dataset (A or B) used .bold[random sampling]?]
...
<center>
<img src="images/bootsample.png" width="50%" height="50%"><br>
...
<center>
<img src="images/bootinf.png" width="50%" height="50%"><br>
...
Go to our class [moodle](https://moodle.carleton.edu), go to the in class activity file, skim through and try to answer the questions
