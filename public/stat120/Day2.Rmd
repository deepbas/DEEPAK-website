...
.center.bold.font140[To eliminate sampling bias always take a .red[RANDOM SAMPLE!]]
...
Go to the  [google form](https://forms.gle/rmKmHPbRoFbWEGXg7)
...
- Go over to [moodle](https://moodle.carleton.edu/course/view.php?id=43041) to get the `class-activity-2.Rmd` file and work on a few problems together
- Dont forget to submit the .pdf file by the deadline
]
]
