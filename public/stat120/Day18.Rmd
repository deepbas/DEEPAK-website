...
background-image: url("images/pooled_proportion.png")
background-size: cover

## .bold[Pooled Proportion]

<center>
<div style="position: absolute; top: 80%; left: 10%;">
<span style="content: '\2192'; font-size: 20px; color: #FFFFFF; text-align: center; white-space: pre-line;">
  <p><strong>Pooling is done to combine the data from both groups and come  <br> up with a combined proportion, assuming the groups are the same</strong></p>
</span>
</div>
</center>
