...
.bq.font90[
- .green-h[Knowing basic statistical jargon] is essential to understand the results of a statistical analysis. 

- Statistical jargon can be used to help .green-h[make decisions] based on data, such as whether or not to reject or accept a hypothesis or to determine if a correlation exists between two variables.

- Understanding statistical terms can help to effectively .green-h[communicate the findings] of a statistical analysis.
]

<!-- It can help to correctly interpret the data and make meaningful conclusions. -->
...
.green-h.font120[Allows us to make informed decisions in the face of uncertainty and let's us take an unbiased and evidence-based viewpoint]
...
- Please download the in-class activity file for Day 1 from [moodle](https://moodle.carleton.edu/) and go to [class activity module](https://stat120-winter23.netlify.app/) 
