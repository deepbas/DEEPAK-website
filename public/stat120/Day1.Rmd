...
.bqt[
1. Mini-lectures
2. Hands-on group activities and quizzes
]
...
.center.font120.purple.b[We will gradually learn these things!]
...
.bql[When one variable helps us understand or predict values of another variable, we call the former the .bold[explanatory variable] and the latter the .bold[response variable]]
