...
.bq.font90[
- .yellow-h[Knowing basic statistical jargon] is essential to understand the results of a statistical analysis. 

- Statistical jargon can be used to help .yellow-h[make decisions] based on data, such as whether or not to reject or accept a hypothesis or to determine if a correlation exists between two variables.

- Understanding statistical terms can help to effectively .yellow-h[communicate the findings] of a statistical analysis.
]
...
.bql[
- A .bold[categorical variable] divides the cases into groups. e.g. gender,
country, state etc.

- A .bold[quantitative variable] measures a numerical quantity for each
