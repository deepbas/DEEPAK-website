...
text(500, 495, "IN", cex = 0.5)# Load necessary libraries
```
]
...
Go to our class [moodle](https://moodle.carleton.edu) and skim through the class activity 
...
.out-t.bold[Correlation = 0.8465, Regression slope = 0.9956 , R-squared = 71.66%]
