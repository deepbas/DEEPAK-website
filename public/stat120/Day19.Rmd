...
.blue-h[.purple[Check:] Check the one sample size conditions for the CLT]
...
- .bold[Conclusion:] There is a statistically discernible difference between the observed mean pH of 6.591 and the hypothesized mean of 7 (t=-2.31, df=52, p=0.025). 
]
]
