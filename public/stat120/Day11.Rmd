...
- Record your answer in .bold[Problem (1a)]
...
Let's see each other's results! Please enter your answer to (1a) in the appropriate Google form:

.bqt[

- [Google form Section 01](https://forms.gle/4ZDAnMka76LqdUVUA)

- [Google form Section 02](https://forms.gle/rEzqai9TCCsG4fep8)
]

`r countdown(minutes = 2, seconds = 00, top = 0 , color_background = "inherit", padding = "3px 4px", font_size = "2em")`
...
- Please do the rest of the class activity and let me know if you have any questions
