---
title: "Cross Validation and Logistic Regression Intro"
...
.font90.bq[
- .out-t.bold[Overfitting:] Good performance on the training data, poor generalization to other data.
- .out-t.bold[Underfitting:] Poor performance on the training data and poor generalization to other data
]
...
.out-t[Don't touch the test data set during model tuning!]
...
<br>
.bq[
- Get the class activity 24.Rmd file from  [moodle](https://moodle.carleton.edu/course/view.php?id=39491) 
...
.panel[.panel-name[Visualizing LR]
