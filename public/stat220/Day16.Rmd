...
.center.green[https://www.mncorn.org/corn-facts/]

--

## .yellow.bold.font150[Can we scrape this webpage?]
...
.bq[SelectorGadget is a point-and-click CSS selector, specifically for .bold[Chrome],  and it comes as a [Chrome Extension](https://chrome.google.com/webstore/detail/selectorgadget/mhjhnkcfbdhnjickkkdbjoemdmbfginb) .red[(Click to install!)]
]
...
background-image: url(images/imdb_tvshows.png)
background-position: center
