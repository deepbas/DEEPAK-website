...
```{r scale-fill, echo=FALSE, out.width="65%", fig.align='center'}
...
```{r echo=FALSE, fig.width=4, fig.height=3, fig.align='center', out.width = "75%"}
set.seed(12345)
fire1 <- fire %>% 
...
<br>
.bq[
- Get the class activity 20.Rmd file from  [moodle](https://moodle.carleton.edu/course/view.php?id=39491) and work on activity 1
]

Here is the confusion matrix for a hypothetical two-class 7-NN penguin classifier
...
.out-t.center[Choose the optimal K based on majority of the metrics!]
