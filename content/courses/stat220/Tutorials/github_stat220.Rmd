...
in [Software in Stat 220](software.Rmd)) to use GitHub connected
projects.
...
1.  Go to our course GitHub organization page
    (<https://deepbas.netlify.app/courses/>) and find your homework repo, such as `hw-1-username` (where your username is attached).
