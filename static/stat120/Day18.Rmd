...
.bql[
A difference in survival rates as extreme, or more extreme, than $16 \%$ would occur by chance only about $0.08 \%$ of the time. There is a statistically significant difference $(\mathrm{z}=-3.34, \mathrm{p}=0.0008)$
]
<br>
