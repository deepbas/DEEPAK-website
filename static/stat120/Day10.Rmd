...
.bqt[Difference in mean responses $\mu_1 - \mu_2$, where $\mu_1$ and $\mu_2$ are the mean words recalled in the two different conditions]
...
.bq[
$$\begin{array}{ll}
\mathrm{H}_{0}: \mu_{1}=\mu_{2} & \qquad \mathrm{H}_{0}: \mu_{1}-\mu_{2}=0 \\
\mathrm{H}_{\mathrm{a}}: \mu_{1} \neq \mu_{2} & \qquad \mathrm{H}_{\mathrm{a}}: \mu_{1}-\mu_{2} \neq 0
\end{array}$$
]
...
.blue-h[We assess this with a probability that we call a "p-value."]
