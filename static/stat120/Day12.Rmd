...
.pull-left[
.hjls[p= Proportion of correct guesses]
$$\begin{array}{l}
...
.bql[
- If the p-value is small, then a statistic as extreme as that observed would be unlikely if the null hypothesis were true, providing significant evidence against $\mathrm{H}_0$
