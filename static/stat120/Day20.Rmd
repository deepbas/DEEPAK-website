...
.bq.font80[**Chi-square test for association**
...
\begin{aligned}
\chi^2 &= \frac{(36-28.33)^2}{28.33} + \cdots + \cdots\\
&\approx 2.076 + \cdots + \cdots
\end{aligned}
]
...
<details>
<summary>.red[Click for answer]</summary>
.hljs[The correct answer is Yes. This is because we do not have sufficient evidence for the alternative assumption, and by implication the null distribution should be true.]
</details>
...
- Complete the activity as much as possible
]
]
