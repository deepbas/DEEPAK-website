...
.bq.font80[Movie world gross (millions of dollars) stats with and without Harry Potter movie (outlier!):
...
.bql[`which` identifies the .bold[row number] of cases that satisfy a given criteria]
