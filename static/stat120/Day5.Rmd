...
.bql.font60[Use `group_by()` and `summarise()` to get summary statistics using `dplyr` package to compare distributions across different levels of a categorical variable
]
...
.footnote[Link to [tutorial](https://stat120-fall23.netlify.app/tutorial-3-dive-deeper-into-data-manipulation-with-dplyr-in-r)]
...
- Let's head over to the [course helper page](https://stat120-winter24.netlify.app/) to see some more examples 
