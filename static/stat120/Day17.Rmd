...
# Recap: Why are most resampling distributions bell-shaped?
...
.blue-h.center[The larger the sample size (n), the smaller the SE]
...
# Margin of Error (ME) and Sample Size (n)
...
.b[You can choose your sample size in advance, depending on your desired margin of error!]
...
# Margin of Error (ME) and $p$ for fixed $n$
...
<span style="content: '\2192'; font-size: 24px; color: #FF00FF; text-align: center; white-space: pre-line;">
  <p>When our sample suggests an even split, <br> there's more room for variability, <br> leading to a larger ME</p>
</span>
</div>
</center>
...
# .bold[Global warming continued:] Is there solid evidence of global warming?
...
.bq.font80[
.bold[P-value:] proportion above z=8.54 on a N(0,1) curve. Yes, there is statistically discernible evidence that the percentage of Americans that believe in global warming is greater than 50% (z=8.51, $p \approx 0$).
...
# [Statkey:](https://www.lock5stat.com/StatKey/) Does this agree with the bootstrap CI? 
