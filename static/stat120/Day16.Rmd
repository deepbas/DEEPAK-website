...
<center>
<img src="images/day16-1.png" width="80%" height="60%"> <br>
</center>
...
\begin{align*}
n=\left(\frac{z^*}{M E}\right)^2 \hat{p}(1-\hat{p})
\end{align*}

$$n \approx \frac{1}{M E^2}$$
...
<center>
<img src="images/day16-2.png" width="80%" height="60%"> <br>
...
<span style="content: '\2192'; font-size: 40px; color: #FF00FF; text-align: center; white-space: pre-line;">
  <p>n &asymp; &<sup>-1</sup> &#x3BC;<sup>2</sup>E<sup>2</sup></p>
</span>
</div>
</center>
...
.bq[If np0 ≥ 10 and n(1 – p0) ≥ 10, then the p-value can be computed as the area in the tail(s) of a standard normal beyond z.]
...
.bq[We are 95% confident that between 57% and 61% of Americans believe in global warming.]
]
