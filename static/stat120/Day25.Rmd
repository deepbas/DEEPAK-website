...
.bq.font90[ Inference .b[AFTER] doing .b[ANOVA] to compare means for several groups:
...
`r chunk_reveal("boxplot", widths= c(0.4,0.6), font_size_code="70%", title = "## Side-by-side Boxplot")`
...
`r chunk_reveal("normality", widths= c(0.3,0.7), font_size_code="70%", title = "## Approximate normality in groups")`
