...
.out-t.font80.center[Which red case below will have high leverage?]
...
geom_point(aes(y = body_mass_g[294], x = bill_length_mm[294]), shape = 2, col = "black") +
...
# `Penguins` example
.blockquote[
- Removing this one case makes the interaction between species and bill length significant $(\mathrm{F}=4.28, \mathrm{df}= 335, \mathrm{p}=0.01449)$ !
