...
- Holding bill length fixed, $\beta_{2}+\beta_{4} bill$ is the difference in mean mass between .green[Chinstrap] and .red[Adelie]
...
- Difference between mean mass between species depends on bill length
- Holding bill length fixed, $\beta_{3}+\beta_{5} bill$ is the difference in mean mass between .ggplotblue[Gentoo] and .red[Adelie]
