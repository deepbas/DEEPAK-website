...
Today: 
.blockquote-list[
- Multiple predictors (Planar and Quadratic)
...
$$
\begin{aligned}
\widehat{\operatorname{med}(\text { Cost } \mid x)} &=e^{4.3667+0.3722 \log (\text { Sqft })+0.0839 H H \text { Size }} \\
...
`r chunk_reveal("model-corn", font_size_code="60%", title = "## Example: Corn Yield")`

```{r model-corn, fig.width = 3, width = c(4,4), fig.height = 3.5, out.width = "100%", include=FALSE}
...
- Assume all three variables $y, x_{1}$ and $x_{2}$ are quantitative
