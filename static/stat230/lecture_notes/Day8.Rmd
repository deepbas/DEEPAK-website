...
`r chunk_reveal("perch-interaction", font_size_code="50%", title = "## Example: Perch interaction")`

```{r perch-interaction, fig.width = 3, widths = c(0.5,0.5), fig.height = 3, out.width = "80%", include=FALSE}
library(Stat2Data)
data("Perch")
glimpse(Perch)
...
- How does width affect mean weight?
  ...
  - it depends on the length of the fish in a model with a length and width interaction
