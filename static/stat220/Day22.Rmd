...
background-image: url(images/forest_fire.png)
...
.font100.fancy.bq[
- There is a feature-space region for classifying 'fire'
- There is a feature-space region for classifying 'not fire'
- There is a boundary between the two regions 
- This boundary is referred to as the **decision boundary**
]
