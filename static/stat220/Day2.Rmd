...
.pull-right-60[
.bq.font90[
- Let's go over to maize server/ local Rstudio to connect it with the class [Github repository](https://github.com/DataScienceSpring23)
...
- pdf_document (need MikTex, MacTex, or TinyTex installed)
...
df <- tibble(
  ...
  age=c(28, 36, 23),
  trt = c("control", "treatment", "treatment"),
...
.pull-right-60[
<br>
.bq.font80[Go to class_activity_2.Rmd in [moodle](https://moodle.carleton.edu/course/view.php?id=41417)
1. Read through the activity answering any questions asked
4. Submit to moodle when done.
]
]
