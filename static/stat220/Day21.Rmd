...
# .center.yellow.Large[Fire can be deadly, destroying homes, wildlife habitat and timber, and polluting air with harmful emission]
...
- based on two regions of .b[Algeria: the Bejaia] region and the .b[Sidi Bel-Abbes] region. 
- from June 2012 to September 2012
]

.footnote[Click [here](https://archive.ics.uci.edu/dataset/547/algerian+forest+fires+dataset) to learn more about the dataset]
...
.fancy.bqt.font90[
- Predictors with .bold[larger variation] will have larger influence on which cases are “nearest” neighbors
- Methods relying on distance can be .bold[sensitive (i.e. not invariant)] to the scale of the predictors
- .bold[Standardizing] only shifts and rescales the variable, it doesn't change the shape of the distribution
]
...
- .bold[Response variable: `diabetes` =	`pos`, `neg`]

- .bold[Predictor variables: _pregnant, glucose, pressure, triceps, insulin, mass,  pedigree, age_ ]
]
