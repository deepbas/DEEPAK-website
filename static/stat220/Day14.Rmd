---
title: "Functions and advanced text mining"
...
musical_instr_reviews <-  read_csv("https://raw.githubusercontent.com/deepbas/statdatasets/main/musicreviews.csv") %>% rename(ratingOverall = overall)
```
...
# .fancy[Functions and advanced text mining]
...
.pull-right[
<img src="images/07_flowchart_homework_graphjam.jpg" width="80%" align="center" />
]
...
## .yellow.bold.font150[What is the average sentiment of Amazon shoppers purchasing musical instruments?]
...
`r chunk_reveal("demo2", widths = c(40, 60), font_size_code="80%", title = "## Sentiments in Amazon Musical Instruments Reviews")`
