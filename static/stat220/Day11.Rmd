...
```{r}
str_c(class, "meets from", begin_time, "to", end_time, days, "in", building, room, sep = " ")
```
...
```{r}
str_sub(phrase, start = c(1,8), end = c(6,11)) %>% str_flatten(collapse = " ")
```
...
- The .yellow-h[[abe]] means one of a,b, or e
...
background-image: url("images/stringr_character.png")
