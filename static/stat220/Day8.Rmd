...
background-image: url("images/tidyr_cheatsheet.png")
...
df <- data.frame(
  id = c('a', 'b', 'c', 'd'),
  SBP_visit1 = c(130, 120, 130, 119),
  SBP_visit2 = c(110, 116, 136, 106),
  SBP_visit3 = c(112, 122, 138, 118)
)
...
df_long <- data.frame(
  ...
  SBP = c(130, 120, 130, 119, 110, 116, 136, 106, 112, 122, 138, 118)
)
...
.footnote[[`readr` cheat sheet]https://deepbas.io/cheatsheets/readr.pdf)]
...
```{r}
date_periods <- tibble(
  date = ymd("2024-01-13", "2024-03-06", "2025-06-30")
)

date_periods %>%
  mutate(
    add_month = date %m+% months(1), # not
