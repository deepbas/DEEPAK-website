...
.yellow-h.font80[Use features to make subsets of cases that are as similar (“pure”) as possible with respect to the outcome]
...
<br>
.bq[
- Get the class activity 27.Rmd file from  [moodle](https://moodle.carleton.edu/course/view.php?id=43045) 
...
.Large[Now, let's talk about random forest]
...
.hljs[Random forests take decision trees and construct more powerful models in terms of prediction accuracy.]
...
<br>
.bq[
- Let's continue working on group activity 2
]
